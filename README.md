...
| ATK-TA0001 | Initial Access | [SAFE-T1004](techniques/SAFE-T1004/README.md) | Tool Shadowing Attack | Malicious MCP servers impersonate or interfere with legitimate tools to hijack execution within MCP-based workflows through cross-server tool interference |
